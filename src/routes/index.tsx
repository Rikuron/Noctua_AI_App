    ...
    <div className="flex h-screen bg-[#1a1a1a] text-white">
      ...
      <div className="w-64 bg-[#0f0f0f] border-r border-gray-800 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-1">
          ...
          <button className="w-full text-left px-3 py-2 rounded-lg hover:bg-gray-800 text-sm text-gray-300 truncate">
        ...
        <div className="p-3 border-t border-gray-800">
          <button className="w-full px-3 py-2 rounded-lg hover:bg-gray-800 text-sm text-gray-300 flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-linear-to-r from-primary to-secondary flex items-center justify-center font-semibold">
              U
            </div>
            <span>User</span>
          </button>
