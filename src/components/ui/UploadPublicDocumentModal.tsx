                        ...
                        async () => {
                            try {
                                ...
                                await addDoc(collection(db, 'pdfs'), {
                                    ...
                                    extractedText: '' // Initial empty state
                                });
                            } catch (firestoreError) {
                                console.error('Error creating Firestore record:', firestoreError);
                                // We don't fail the upload if Firestore fails, but we log it
                            }
            ...
            <div className="bg-gray-800 rounded-2xl w-full max-w-2xl border border-gray-600 max-h-[90vh] overflow-y-auto shadow-2xl">
                ...
                <div className="p-6">
                    ...
                    <p className="text-sm text-gray-400 mb-6">
                        Upload PDF documents to the centralized repository.<br />
                    ...
                    >
                        ...
                        <h3 className="text-lg font-medium mb-2">Upload public PDFs</h3>
