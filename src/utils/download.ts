 ...
 * Converts markdown content to plain text before downloading.
 * 
 * @param content - The markdown content to convert and download
...
/**
 * Downloads content as a .md (Markdown) file.
 * 
...
/**
 * Generates and downloads a PDF file from markdown content.
 * Converts markdown to plain text, adds headers/footers/metadata, and handles pagination.
 * 
 * @param content - The markdown content to include
 * @param filename - The desired filename (without extension)
 * @param sourceNames - Optional list of source names to display in metadata
 * @param generatedAt - Optional generation date to display
 * @param notebookName - Optional notebook name for the header
